...
\noindent{\bf Discussion:} Our linear regression based model is known to performs poorly when queueing delays become dominant contributors to overall latency~\cite{Stewart07}. 
